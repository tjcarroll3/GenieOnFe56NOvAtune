...
// Tue Jun 21 14:20:22 2022 by ROOT version 6.24/06
// from TTree gst/GENIE Summary Event Tree
// found on file: mecEvents.root
//////////////////////////////////////////////////////////
...
#ifdef mecTree_cxx
mecTree::mecTree(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("Run11FD_mecEvents_Eavail_numu.root");
      if (!f || !f->IsOpen()) {
	f = new TFile("Run11FD_mecEvents_Eavail_numu.root","update");
      }
...
Int_t mecTree::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t mecTree::LoadTree(Long64_t entry)
{
...
void mecTree::Show(Long64_t entry)
{
...
Int_t mecTree::Cut(Long64_t entry)
{
